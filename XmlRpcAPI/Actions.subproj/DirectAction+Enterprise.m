/*
  ...
  02111-1307, USA.
*/
// $Id: DirectAction+Enterprise.m 1 2004-08-20 11:17:52Z znek $
...
- (id)_getEnterpriseByArgument:(id)_arg {
  id tmp = nil;
  ...
  if ([_arg isKindOfClass:[NSDictionary class]]) {
    ...
    return [self _getEnterpriseByNumber:[_arg objectForKey:@"number"]];
  }
