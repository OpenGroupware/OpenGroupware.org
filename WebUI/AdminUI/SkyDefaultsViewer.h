...
#ifndef __AdminUI_SkyDefaultsViewer_H__
#define __AdminUI_SkyDefaultsViewer_H__
...
@interface SkyDefaultsViewer : OGoComponent
{
  NSArray            *domains;
  NSArray            *defaults;
...
#endif /* __AdminUI_SkyDefaultsViewer_H__ */
