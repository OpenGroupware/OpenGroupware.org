...
/*
  !! don't use this command directly,
     it's called from createInvoiceAccountCommand
     use this command !!
 */
@interface LSNewInvoiceAccountCommand : LSDBObjectNewCommand
{
}
@end
...
@interface LSNewInvoiceAccountCommand(PrivateMethods)
@end

@implementation LSNewInvoiceAccountCommand
