...
#import "common.h"
#import "LSSetInvoiceArticleAssignmentCommand.h"

@implementation LSSetInvoiceArticleAssignmentCommand
...
- (void)_prepareForExecutionInContext:(id)_context {
  ...
  parent = [invoice valueForKey:@"parentInvoiceId"];
  [self assert:((parent == nil) || (![parent isNotNull]))
        reason:@"Invoice Assignments not editable with this Invoice type."];
  [self assert:access
