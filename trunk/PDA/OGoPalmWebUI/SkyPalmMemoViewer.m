...
@interface SkyPalmMemoViewer: SkyPalmEntryViewer
{
...
@implementation SkyPalmMemoViewer
...
- (BOOL)canAssignSkyrixRecord {
  return [[self memo] canAssignSkyrixRecord];
}
- (BOOL)canCreateSkyrixRecord {
  return [[self memo] canCreateSkyrixRecord];
}

@end /* SkyPalmMemoViewer */
