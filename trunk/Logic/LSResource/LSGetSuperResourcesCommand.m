...
@interface LSGetSuperResourcesCommand : LSBaseCommand
@end

#include "common.h"

@implementation LSGetSuperResourcesCommand

- (void)_executeInContext:(id)_context {
  // TODO: this looks like a DUP to LSExtendedSearchSingleResourceCommand.m
  ...
  assignList = [[self object] valueForKey:@"toSuperResourceAssignment"];
  ...
  if (![assignList isNotNull]) {
    ...
    while ((assignment = [assignEnum nextObject])) {
      ...
      tmp = [assignment valueForKey:@"toSuperResource"];
      if ([tmp isNotNull])
...
@end /* LSGetSuperResourcesCommand */
