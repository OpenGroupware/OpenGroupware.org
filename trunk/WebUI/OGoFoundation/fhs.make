...
fhs-header-dirs ::
	$(MKDIRS) $(FHS_INCLUDE_DIR)$(libOGoFoundation_HEADER_FILES_INSTALL_DIR)
...
move-headers-to-fhs :: fhs-header-dirs
	...
	mv $(GNUSTEP_HEADERS)$(libOGoFoundation_HEADER_FILES_INSTALL_DIR)/*.h \
	  $(FHS_INCLUDE_DIR)$(libOGoFoundation_HEADER_FILES_INSTALL_DIR)/
