...
#ifndef __NGXmlRpcAction_Introspection_H__
#define __NGXmlRpcAction_Introspection_H__

#include <NGXmlRpc/NGXmlRpcAction.h>

@interface NGXmlRpcAction(Introspection)
...
#endif /* __NGXmlRpcAction_Introspection_H__ */
