...
#ifndef __SkyIDL_SkyIDLSaxBuilder_H__
#define __SkyIDL_SkyIDLSaxBuilder_H__

#import <Foundation/NSObject.h>
#include <SaxObjC/SaxDefaultHandler.h>

@class NSString, NSData, NSMutableArray, NSMutableString, NSMutableDictionary;
@class SkyIDLInterface;

@interface SkyIDLSaxBuilder : SaxDefaultHandler
{
...
#endif /* __SkyIDL_SkyIDLSaxBuilder_H__ */
