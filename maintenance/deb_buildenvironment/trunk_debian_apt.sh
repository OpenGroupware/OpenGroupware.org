...
Architecture: i386" >/var/virtual_hosts/download/packages/debian/dists/${FLAVOUR}/trunk/binary-i386/Release

/usr/bin/apt-ftparchive release \
  /var/virtual_hosts/download/packages/debian/dists/${FLAVOUR}/trunk/binary-i386 \
  >> /var/virtual_hosts/download/packages/debian/dists/${FLAVOUR}/trunk/binary-i386/Release

/usr/bin/expect -c \
  "spawn /usr/bin/gpg --sign -ba /var/virtual_hosts/download/packages/debian/dists/${FLAVOUR}/trunk/binary-i386/Release; \
