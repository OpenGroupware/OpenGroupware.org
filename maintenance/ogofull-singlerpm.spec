...
%define ogoall_ogo_source               opengroupware.org-1.3.0-ultra-r829.tar.gz
...
SHAREDIR_OGO="${RPM_BUILD_ROOT}%{prefix}/share/opengroupware.org-1.3"
...
if [ $1 = 1 ]; then
  ...
  if [ -f "/etc/SuSE-release" ]; then
    sed "s^NHSD_INIT_VERSION^${NHSD_INIT_VERSION}^g; \
         ...
         "%{prefix}/share/opengroupware.org-1.3/initscript_templates/suse_nhsd" \
    ...
    sed "s^NHSD_INIT_VERSION^${NHSD_INIT_VERSION}^g; \
         s^NHSD_INIT_PREFIX^${NHSD_INIT_PREFIX}^g" \
         "%{prefix}/share/opengroupware.org-1.3/initscript_templates/redhat_nhsd" \
         >%{_sysconfdir}/init.d/"${NHSD_INIT_VERSION}"
    chown root:root %{_sysconfdir}/init.d/"${NHSD_INIT_VERSION}"
    chmod 755 %{_sysconfdir}/init.d/"${NHSD_INIT_VERSION}"
  ...
  if [ -f "/etc/SuSE-release" ]; then
    sed "s^OGO_INIT_VERSION^${OGO_INIT_VERSION}^g; \
         ...
         "%{prefix}/share/opengroupware.org-1.3/initscript_templates/suse_opengroupware" \
    ...
    sed "s^OGO_INIT_VERSION^${OGO_INIT_VERSION}^g; \
         s^OGO_INIT_PREFIX^${OGO_INIT_PREFIX}^g" \
         "%{prefix}/share/opengroupware.org-1.3/initscript_templates/redhat_opengroupware" \
         >%{_sysconfdir}/init.d/"${OGO_INIT_VERSION}"
    chown root:root %{_sysconfdir}/init.d/"${OGO_INIT_VERSION}"
    chmod 755 %{_sysconfdir}/init.d/"${OGO_INIT_VERSION}"
  ...
  if [ -f "/etc/SuSE-release" ]; then
    sed "s^XMLRPCD_INIT_VERSION^${XMLRPCD_INIT_VERSION}^g; \
         ...
         "%{prefix}/share/opengroupware.org-1.3/initscript_templates/suse_xmlrpcd" \
    ...
    sed "s^XMLRPCD_INIT_VERSION^${XMLRPCD_INIT_VERSION}^g; \
         s^XMLRPCD_INIT_PREFIX^${XMLRPCD_INIT_PREFIX}^g" \
         "%{prefix}/share/opengroupware.org-1.3/initscript_templates/redhat_xmlrpcd" \
         >%{_sysconfdir}/init.d/"${XMLRPCD_INIT_VERSION}"
    chown root:root %{_sysconfdir}/init.d/"${XMLRPCD_INIT_VERSION}"
    chmod 755 %{_sysconfdir}/init.d/"${XMLRPCD_INIT_VERSION}"
  ...
  sed "s^OGO_SYSCONF^${OGO_SYSCONF}^g; \
       ...
       "%{prefix}/share/opengroupware.org-1.3/aptnotify_template/ogo-aptnotify.sh" \
  ...
  Defaults write ogo-nhsd-1.1 NGBundlePath '%{prefix}/lib/opengroupware.org-1.3/conduits'
  "
  ##
  chmod 755 ${OGO_HOME}
  ##
...
%{prefix}/lib/opengroupware.org-1.3/commands/LSAccount.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSAddress.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSBase.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSDocuments.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSEnterprise.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSMail.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSNews.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSPerson.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSProject.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSScheduler.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSSearch.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSTasks.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/LSTeam.cmd
%{prefix}/lib/opengroupware.org-1.3/commands/OGo.model
%{prefix}/lib/opengroupware.org-1.3/conduits/OpenGroupwareNHS.conduit/OpenGroupwareNHS
%{prefix}/lib/opengroupware.org-1.3/conduits/OpenGroupwareNHS.conduit/Resources/Info-gnustep.plist
%{prefix}/lib/opengroupware.org-1.3/conduits/OpenGroupwareNHS.conduit/bundle-info.plist
%{prefix}/lib/opengroupware.org-1.3/conduits/OpenGroupwareNHS.conduit/stamp.make
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoAccounts.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoBase.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoContacts.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoDatabaseProject.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoFileSystemProject.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoJobs.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoPalmDS.ds/OGoPalmDS
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoPalmDS.ds/Resources/Info-gnustep.plist
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoPalmDS.ds/bundle-info.plist
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoPalmDS.ds/stamp.make
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoProject.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoRawDatabase.ds
%{prefix}/lib/opengroupware.org-1.3/datasources/OGoScheduler.ds
%{prefix}/lib/opengroupware.org-1.3/webui/AddressUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/AdminUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/BaseUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/EnterprisesUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/JobUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/LDAPAccounts.lso
%{prefix}/lib/opengroupware.org-1.3/webui/LSWMail.lso
%{prefix}/lib/opengroupware.org-1.3/webui/LSWProject.lso
%{prefix}/lib/opengroupware.org-1.3/webui/LSWScheduler.lso
%{prefix}/lib/opengroupware.org-1.3/webui/NewsUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoDocInlineViewers.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoMailEditor.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoMailFilter.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoMailInfo.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoMailViewers.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoNote.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoPalm.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoProject.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoProjectInfo.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoProjectZip.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoRecipientLists.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoResourceScheduler.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoScheduler.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoSchedulerDock.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoSchedulerViews.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoUIElements.lso
%{prefix}/lib/opengroupware.org-1.3/webui/OGoWebMail.lso
%{prefix}/lib/opengroupware.org-1.3/webui/PersonsUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/PreferencesUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/PropertiesUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/RelatedLinksUI.lso
%{prefix}/lib/opengroupware.org-1.3/webui/SoOGo.lso
...
%{prefix}/share/opengroupware.org-1.3/initscript_templates/*xmlrpcd
%{prefix}/share/zidestore-1.5
%{prefix}/share/opengroupware.org-1.3/INSTALLED.USING.OGOFULLPACKAGE
%{prefix}/share/opengroupware.org-1.3/Holidays.plist
%{prefix}/share/opengroupware.org-1.3/initscript_templates/*nhsd
%{prefix}/share/opengroupware.org-1.3/initscript_templates/*opengroupware
%{prefix}/share/opengroupware.org-1.3/templates/AddressUI
%{prefix}/share/opengroupware.org-1.3/templates/AdminUI
%{prefix}/share/opengroupware.org-1.3/templates/BaseUI
%{prefix}/share/opengroupware.org-1.3/templates/EnterprisesUI
%{prefix}/share/opengroupware.org-1.3/templates/JobUI
%{prefix}/share/opengroupware.org-1.3/templates/LDAPAccounts
%{prefix}/share/opengroupware.org-1.3/templates/LSWMail
%{prefix}/share/opengroupware.org-1.3/templates/LSWProject
%{prefix}/share/opengroupware.org-1.3/templates/LSWScheduler
%{prefix}/share/opengroupware.org-1.3/templates/NewsUI
%{prefix}/share/opengroupware.org-1.3/templates/OGoDocInlineViewers
%{prefix}/share/opengroupware.org-1.3/templates/OGoMailEditor
%{prefix}/share/opengroupware.org-1.3/templates/OGoMailFilter
%{prefix}/share/opengroupware.org-1.3/templates/OGoMailInfo
%{prefix}/share/opengroupware.org-1.3/templates/OGoMailViewers
%{prefix}/share/opengroupware.org-1.3/templates/OGoNote
%{prefix}/share/opengroupware.org-1.3/templates/OGoProject
%{prefix}/share/opengroupware.org-1.3/templates/OGoProjectInfo
%{prefix}/share/opengroupware.org-1.3/templates/OGoProjectZip
%{prefix}/share/opengroupware.org-1.3/templates/OGoRecipientLists
%{prefix}/share/opengroupware.org-1.3/templates/OGoResourceScheduler
%{prefix}/share/opengroupware.org-1.3/templates/OGoScheduler
%{prefix}/share/opengroupware.org-1.3/templates/OGoSchedulerDock
%{prefix}/share/opengroupware.org-1.3/templates/OGoSchedulerViews
%{prefix}/share/opengroupware.org-1.3/templates/OGoUIElements
%{prefix}/share/opengroupware.org-1.3/templates/OGoWebMail
%{prefix}/share/opengroupware.org-1.3/templates/PersonsUI
%{prefix}/share/opengroupware.org-1.3/templates/PreferencesUI
%{prefix}/share/opengroupware.org-1.3/templates/PropertiesUI
%{prefix}/share/opengroupware.org-1.3/templates/RelatedLinksUI
%{prefix}/share/opengroupware.org-1.3/templates/Themes/OOo
%{prefix}/share/opengroupware.org-1.3/templates/Themes/blue
%{prefix}/share/opengroupware.org-1.3/templates/Themes/kde
%{prefix}/share/opengroupware.org-1.3/templates/Themes/orange
%{prefix}/share/opengroupware.org-1.3/templates/ogo-webui-1.1
%{prefix}/share/opengroupware.org-1.3/www/Danish.lproj
%{prefix}/share/opengroupware.org-1.3/www/English.lproj
%{prefix}/share/opengroupware.org-1.3/www/English_OOo.lproj
%{prefix}/share/opengroupware.org-1.3/www/English_blue.lproj
%{prefix}/share/opengroupware.org-1.3/www/English_kde.lproj
%{prefix}/share/opengroupware.org-1.3/www/English_orange.lproj
%{prefix}/share/opengroupware.org-1.3/www/German.lproj
%{prefix}/share/opengroupware.org-1.3/www/German_OOo.lproj
%{prefix}/share/opengroupware.org-1.3/www/German_blue.lproj
%{prefix}/share/opengroupware.org-1.3/www/German_orange.lproj
%{prefix}/share/opengroupware.org-1.3/www/Italian.lproj
%{prefix}/share/opengroupware.org-1.3/www/Polish.lproj
%{prefix}/share/opengroupware.org-1.3/www/Spanish.lproj
%{prefix}/share/opengroupware.org-1.3/www/WOStats.xsl
%{prefix}/share/opengroupware.org-1.3/www/menu.js

# translations
%{prefix}/share/opengroupware.org-1.3/translations/Basque.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Danish.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Dutch.lproj
%{prefix}/share/opengroupware.org-1.3/translations/English.lproj
%{prefix}/share/opengroupware.org-1.3/translations/French.lproj
%{prefix}/share/opengroupware.org-1.3/translations/German.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Hungarian.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Italian.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Japanese.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Norwegian.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Polish.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Portuguese.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Slovak.lproj
%{prefix}/share/opengroupware.org-1.3/translations/Spanish.lproj
%{prefix}/share/opengroupware.org-1.3/translations/ptBR.lproj
