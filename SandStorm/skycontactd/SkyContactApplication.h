...
#ifndef __SkyContactDaemon_SkyContactApplication_H__
#define __SkyContactDaemon_SkyContactApplication_H__
...
@interface SkyContactApplication : SDApplication
{
...
@end /* SkyContactApplication */

#endif /* __SkyContactDaemon_SkyContactApplication_H__ */
