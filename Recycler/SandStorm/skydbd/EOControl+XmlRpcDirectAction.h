...
#ifndef __SkyDBServer_EOControl_XmlRpcDirectAction_H__
#define __SkyDBServer_EOControl_XmlRpcDirectAction_H__
...
#endif /* __SkyDBServer_EOControl_XmlRpcDirectAction_H__ */
