...
#ifndef __SandStorm_ComponentList_H__
#define __SandStorm_ComponentList_H__

#import <Foundation/NSObject.h>

@class NSArray, ComponentElement;

@interface ComponentList : NSObject
{
  NSMutableArray *components;
  NSMutableArray *componentNamespaces;
}
...
#endif /* __SandStorm_ComponentList_H__ */
