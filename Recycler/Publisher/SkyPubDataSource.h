...
#ifndef __SkyPubDataSource_H__
#define __SkyPubDataSource_H__

#include <NGExtensions/EOFilterDataSource.h>

@class SkyPubFileManager;

@interface SkyPubDataSource : EOFilterDataSource
{
...
@interface EODataSource(PubDS)
- (SkyPubDataSource *)asPubDataSource;
@end /* EODataSource(PubDS) */

#endif /* __SkyPubDataSource_H__ */
