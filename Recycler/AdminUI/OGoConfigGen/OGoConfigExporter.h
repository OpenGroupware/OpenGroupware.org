...
#ifndef __testtool_OGoConfigExporter_H__
#define __testtool_OGoConfigExporter_H__

#import <Foundation/NSObject.h>

@class NSException;
@class OGoConfigDatabase, OGoConfigGenTransaction;

@interface OGoConfigExporter : NSObject
{
...
#endif /* __testtool_OGoConfigExporter_H__ */
