...
#ifndef __OGoVirtualConfigFile_H__
#define __OGoVirtualConfigFile_H__

#include "OGoConfigFile.h"

@class NSString, NSArray, NSException;

@protocol OGoVirtualEntryConsumer
...
@interface OGoVirtualConfigFile : OGoConfigFile
{
}
...
#endif /* __OGoVirtualConfigFile_H__ */
