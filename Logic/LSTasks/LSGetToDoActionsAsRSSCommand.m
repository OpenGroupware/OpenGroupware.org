...
@interface LSGetToDoActionsAsRSSCommand : LSGetAsRSSFeedCommand
{
  NSString         *accountId;
...
@implementation LSGetToDoActionsAsRSSCommand
...
- (void)appendRSSItem:(NSDictionary *)_record {
  ...
  guid = [NSString stringWithFormat:@"OGo-TaskAction-%@-todo", tmp];
