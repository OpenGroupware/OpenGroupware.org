...
@interface LSRemoveLogsCommand : LSDBObjectDeleteCommand
@end

#import "common.h"

@implementation LSRemoveLogsCommand
...
- (void)_executeInContext:(id)_context {
  ...
  if (![adCh deleteRowsDescribedByQualifier:q])
    NSLog(@"WARNING: Couldn't delete log rows for object '%@' ...",
	  [[self object] valueForKey:pkeyName]);
