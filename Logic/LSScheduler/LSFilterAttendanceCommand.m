...
@interface LSFilterAttendanceCommand : LSArrayFilterCommand
{
@private
  NSNumber       *weekDay;
...
@implementation LSFilterAttendanceCommand
...
- (BOOL)includeObjectInResult:(id)_object {
  return [_object filterAttendanceWithSpec:self];
}
