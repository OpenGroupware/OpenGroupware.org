...
fhs-header-dirs ::
	$(MKDIRS) $(FHS_INCLUDE_DIR)$(libLSFoundation_HEADER_FILES_INSTALL_DIR)
...
move-headers-to-fhs :: fhs-header-dirs
	...
	mv $(GNUSTEP_HEADERS)$(libLSFoundation_HEADER_FILES_INSTALL_DIR)/*.h \
	  $(FHS_INCLUDE_DIR)$(libLSFoundation_HEADER_FILES_INSTALL_DIR)/
