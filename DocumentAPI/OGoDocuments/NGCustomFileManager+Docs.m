...
#include "SkyDocumentFileManager.h"

@implementation NGCustomFileManager(Docs)
...
- (id)documentAtPath:(NSString *)_path {
  ...
  if ((_path = [info rewriteAbsolutePath:_path])   == nil) return nil;
  if ((fm = [info fileManager])                    == nil) return nil;
