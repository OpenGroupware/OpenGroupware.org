...
#ifndef __SkyFSFolderDataSource_H__
#define __SkyFSFolderDataSource_H__
...
- (id)initWithPath:(NSString *)_path fileManager:(SkyFSFileManager *)_fm;
...
#endif /*__SkyFSFolderDataSource_H__ */
